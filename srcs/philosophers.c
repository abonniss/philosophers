...
/*   Updated: 2022/03/14 13:34:01 by abonniss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	fill_prog_info(char **inputs, t_prog *ptr_prog)
{
	...
	ptr_prog->time_to_die = ft_atol(inputs[TIME_TO_DIE_ARG]) * 1000;
	ptr_prog->time_to_eat = ft_atol(inputs[TIME_TO_EAT_ARG]) * 1000;
	ptr_prog->time_to_sleep = ft_atol(inputs[TIME_TO_SLEEP_ARG]) * 1000;
